...
- 新增复盘基础模式，支持对局结束后立即进入复盘
- 新增最近一局与最近 20 局任意一局复盘入口
- 复盘支持开局、上一步、下一步、终局与自动播放
- 复盘终局可重现胜利线，并在退出后恢复当前对局节奏

### `9dec553` `docs: record replay enhancements`

- 同步 README、CHANGELOG、VERSIONING 的复盘能力说明
